...
//        String articleId = "1";
        ...
        List<Map<String,String>> articleList=getArticlesByVote(conn,1);
...
//        printArticles(articles);
    ...
    public String postArticle(Jedis conn, String user, String title, String link) {
        ...
        conn.zadd("votesTime:votes",1,article);
        return articleId;
    }
    ...
    public void articleVote(Jedis conn, String user, String article) {
        ...
        if (conn.sadd("voted:" + articleId, user) == 1) {
            ...
            conn.zincrby("votesTime:votes", 1,article);
        }
    }
    ...
    public List<Map<String,String>> getArticlesByVote(Jedis conn, int page) {
        ...
        Set<String> ids = conn.zrevrange("votesTime:votes", start, end);
